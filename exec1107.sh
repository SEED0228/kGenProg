...
cp kgenprog-out/history.json json20221107-1/qs_z.json
cp stDev.csv json20221107-1/qs_z.csv
...
cp kgenprog-out/history.json json20221107-1/qs_o.json
cp stDev.csv json20221107-1/qs_o.csv
...
cp kgenprog-out/history.json json20221107-1/qs_a.json
cp stDev.csv json20221107-1/qs_a.csv
...
cp kgenprog-out/history.json json20221107-1/qs_t.json
cp stDev.csv json20221107-1/qs_t.csv
...
cp kgenprog-out/history.json json20221107-1/qs_d.json
cp stDev.csv json20221107-1/qs_d.csv
...
cp kgenprog-out/history.json json20221107-1/qs_j.json
cp stDev.csv json20221107-1/qs_j.csv
